...
class  SerializationTest 
{
	public static void main(String[] args) throws FileNotFoundException,IOException
	{
		...
		FileOutputStream fos = new FileOutputStream("abc1.txt"); //file to be created
		...
		System.out.println("Serialisation proess completed: ");  //Serialisation proess completed:
		//I would like to trnsffer abc.txt file through network
	}
}
/***
produced file "abc1.txt" contains the following:
¬í sr EmpOÖæAÑY I eidxp   o
***/